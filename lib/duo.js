...
Duo.prototype.resolve = function *(file) {
  ...
  yield this.resolveCode(file, json);
  return;
};
...
Duo.prototype.resolvedLocally = function *(file, json) {
  ...
  var isParsed = this.deps[file.id];
...
Duo.prototype.resolveCode = function *(file, json) {
